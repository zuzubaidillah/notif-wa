							...
							<form method="post" action="<?= $rootss . 'proses_update/' . $id ?>">
								...
								<div class="form-row ">
									<div class="form-group col-md-8">
										...
										<input value="<?= $dari ?>" required autofocus maxlength="150" type="text" class="form-control" id="dari" name="dari" placeholder="Masukan data yang sesuai">
									...
									<div class="form-check col-md-4">
										...
										<label class="form-radio-label">
											<input <?= $hPu ?> class="form-radio-input" type="radio" name="jenis" value="public" checked="">
											<span for="jenis" class="form-radio-sign">Public</span>
										</label>
										<label class="form-radio-label ml-3">
											<input <?= $hPr ?> class="form-radio-input" type="radio" name="jenis" value="private">
								...
								<div class="form-row">
									<div class="form-group col-md-5">
										<div class="form-row">
											<div class="form-group col-sm-12 col-md-6">
												...
												<input required type="date" value="<?= $waktu ?>" class="form-control" id="tgl" name="tgl">
											</div>
											<div class="form-group col-sm-12 col-md-6">
												<label for="tgl">Jam Agenda</label>
												<input required type="time" value="<?= $jam ?>" class="form-control" id="jam" name="jam">
											</div>
									...
									<div class="form-group col-md-7">
										...
										<div class="form-group">
											...
											<textarea rows="5" required class="form-control" id="keterangan" name="keterangan" placeholder="Isi deskripsi / keterangan lengkap"><?= $deskripsi ?></textarea>
