							...
							<form method="post" action="<?= $rootss . 'proses_add' ?>">
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										...
										<select required <?= $lembagaAttribute ?? "" ?> class="form-control" id="lembaga" name="lembaga">
								...
								<div class="form-row ">
									<div class="form-group col-md-8">
										...
										<input required autofocus maxlength="150" type="text" class="form-control" id="dari" name="dari" placeholder="Masukan data yang sesuai">
									...
									<div class="form-check col-md-4">
										...
										<label class="form-radio-label">
											<input class="form-radio-input" type="radio" name="jenis" value="public" checked="">
								...
								<div class="form-row">
									<div class="form-group col-md-5">
										<div class="form-row">
											<div class="form-group col-sm-12 col-md-6">
												...
												<input required type="date" value="<?= date('Y-m-d') ?>" class="form-control" id="tgl" name="tgl">
											</div>
											<div class="form-group col-sm-12 col-md-6">
												<label for="tgl">Jam Agenda</label>
												<input required type="time" value="07:00" class="form-control" id="jam" name="jam">
											</div>

											<div class="form-group col-md-12">
												<label for="durasi">Durasi Pengingat, Sebelum kegiatan</label>
												<input required maxlength="5" type="number" class="form-control" id="durasi" name="durasi" placeholder="isikan durasi perdetik">
									...
									<div class="form-group col-md-7">
										...
										<div class="form-group">
											...
											<textarea rows="5" required class="form-control" id="keterangan" name="keterangan" placeholder="Isi deskripsi / keterangan lengkap"></textarea>
											<small class="form-text text-muted">Pastikan sejelas mungkin, ini yang akan di
