							...
							<form method="post" action="<?= $rootss . 'proses_add' ?>">
								...
								<div class="form-row ">
									<div class="form-group col-md-8">
										...
										<input required autofocus maxlength="150" type="text" class="form-control" id="n" name="n" placeholder="Masukan Nama">
									</div>
								...
								<div class="form-row">
									<div class="form-group col-md-5">
										...
										<input required type="text" class="form-control" id="kel" name="kel" placeholder="Isi Kelahiran">
									</div>
									...
									<div class="form-group col-md-4">
										...
										<input required maxlength="16" type="text" class="form-control" id="nomor" name="nomor" placeholder="Nomor Telpon sesuai Whatsapp">
									</div>
								</div>
