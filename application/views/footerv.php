<footer class="footer">
	<div class="container-fluid">
		...
		<div class="copyright ml-auto">
			<?= $labels['admin-panel']['footerKananTahun'] ?? "Footer 2022 Default"; ?>, made with
			<i class="fa fa-heart heart text-danger"></i> by
			<a href="https://www.themekita.com"><?= $labels['admin-panel']['footerKananBy'] ?? "Footer Apps Default"; ?></a>
		</div>
	</div>
</footer>
</div>
